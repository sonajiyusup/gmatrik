 ...
 ?>
    ...
    <!-- Bar Chart -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>DATA NILAI RATA-RATA PRESENSI TA'LIM MAHASISWA
                            <small>Berdasarkan Pembina</small>
                          </h2>
                        </div>
                        <div class="body">
                          <div class="table-responsive">
                            <table id="tableTalimByPembina" class="table table-hover table-condensed">
                              <thead>
                                <tr>
                                  <th>#</th>
                                  <th>Nama Pembina</th>
...
<!-- Daterange picker import data presensi shalat mahasiswa -->
    ...
    $(document).ready(function() {
      var t = $('#tableTalimByPembina').DataTable({});
    } );
    </script> 