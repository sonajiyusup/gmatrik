...
<div class="row clearfix">
                <div class="col-md-6">
                    <div class="card">
                        <div class="header">
                            <h2><a href="?page=ortudetail&id=<?php echo $id; ?>" class="btn btn-sm btn-link waves-effect" title="Kembali"><i class="material-icons">arrow_back</i></a>&nbsp;&nbsp;&nbsp;EDIT DATA PROFIL ORANG TUA MAHASISWA
                            </h2>
                        </div>
                        <div class="body">
                          <form method="POST">
...
<?php
    if(isset($_POST['editOrtu'])) {
      editOrtu($id, $_POST['namaOrtu'], $_POST['alamat'], $_POST['email'], $_POST['telp'], $_POST['idMahasiswa']);
      echo "<script>document.location='?page=ortudetail&id=".$id."'</script>";
    }
  } 
?>