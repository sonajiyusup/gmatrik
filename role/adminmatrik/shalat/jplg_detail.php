                              ...
                              <table id="tableJplgDetail" class="table table-condensed">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo "<a title='Hapus' style='color:#DD4B39;' href='#ModalHapusJplg' class='dropdown-item' data-toggle='modal' data-href='action/hapus.php?idjplg=".$row['tanggal']."' aria-hidden='true'><i class='material-icons' style='font-size: 20px'>cancel</i></a>"; ?></td>
                                  </tr>
                                  <?php $no++; } } ?>
                                </tbody> 
                              </table>                          
