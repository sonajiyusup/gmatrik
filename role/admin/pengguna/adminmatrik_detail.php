...
<div class="container-fluid">
  <div class="row clearfix">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2><a href="?page=adminmatrik" class="btn btn-sm btn-link waves-effect" style="width: 10%;" title="Kembali"><i class="material-icons">arrow_back</i></a>&nbsp;&nbsp;&nbsp;PROFIL ADMIN MATRIKULASI
                            </h2>
                        </div>
                        <div class="body table-responsive">
                            ...
                            <col width="350">
                              ...
                              <?php echo "<a class='btn btn-danger btn-block waves-effect' href='#ModalHapusMahasiswa' data-toggle='modal' data-href='action/hapus.php?idmahasiswa=".$row['id_adminmatrik']."&iduser=".$row['id_user']."'><i class='material-icons' style='font-size: 16px'>delete</i><span>&nbsp;HAPUS ADMIN MATRIK</span></a>"; ?>
                        </div>
                        <?php } ?>
                    </div>
                </div>
