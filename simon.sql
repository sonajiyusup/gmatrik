...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2018 at 11:20 AM
...
(4, 'Ilyas Doang', NULL, NULL, 'Ikhwan', NULL, 420, NULL),
(5, 'Oki Satriyan Seno', NULL, NULL, 'Ikhwan', NULL, 421, NULL),
(7, 'Ikka', NULL, NULL, 'Akhwat', NULL, 421, NULL),
(8, 'Ikka Annisa', NULL, NULL, 'Akhwat', NULL, 431, NULL);
...
(1243, 17101040, 'Alin Duani', NULL, 'Akhwat', NULL, NULL, NULL, 'maxresdefault.jpg', NULL, 102),
...
(1264, 17101045, 'Zakia Chairani Ayudia', NULL, 'Ikhwan', NULL, NULL, NULL, NULL, NULL, 123),
...
(1316, 17101081, 'Baiq Damayanti Azhar Put', NULL, 'Ikhwan', NULL, NULL, NULL, NULL, NULL, 175),
...
(1397, 17101122, 'Ahlam Nabila', NULL, 'Akhwat', NULL, NULL, NULL, NULL, NULL, 256),
...
(2, 'derry', 'bismillah', 0, 2, '2018-04-24 09:52:51'),
...
(420, 'ilyas', '1cjPOvielW', 0, 2, '0000-00-00 00:00:00'),
(421, 'oki', '0AoAM3TKm2', 1, 2, '0000-00-00 00:00:00'),
(431, 'ikka', '4XH729vvld', 1, 2, '0000-00-00 00:00:00');
...
--
ALTER TABLE `adminmatrik`
  MODIFY `id_adminmatrik` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `m_binaan`
--
ALTER TABLE `m_binaan`
  MODIFY `id_mhsbinaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
